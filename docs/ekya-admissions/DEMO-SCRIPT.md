...
**Presenting:** generate the deck in Zoho Show from [show/COPY-INTO-ZIA.md](show/COPY-INTO-ZIA.md), or import [Ekya-CMR-Admissions-Demo.pptx](show/Ekya-CMR-Admissions-Demo.pptx). Advance the matching slide, then click CRM. Speaker notes are the talk track.
